...
*"  TABLES
*"      OUT_ALIAS STRUCTURE  ZST_ALIAS OPTIONAL
*"      OUT_TRX STRUCTURE  ZST_TRXS OPTIONAL
*"      OUT_1251 STRUCTURE  ZST_1251 OPTIONAL
*"      OUT_1252 STRUCTURE  ZST_1252 OPTIONAL
*"      OUT_ROL_AGR_PR STRUCTURE  ZST_ROL_AGR_PR OPTIONAL
*"      OUT_ROL_AGR_DE STRUCTURE  ZST_ROL_AGR_DE OPTIONAL
*"      OUT_USE_GEN_DA STRUCTURE  ZST_ROL_AGR_DA OPTIONAL
*"      OUT_USE_TOTAL STRUCTURE  ZST_USE_TOTAL OPTIONAL
*"      OUT_ROL_AGR_TEXT STRUCTURE  ZST_ROL_AGR_PR OPTIONAL
*"----------------------------------------------------------------------
